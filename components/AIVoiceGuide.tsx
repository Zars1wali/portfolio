...
const PAGE_SCRIPTS: Record<string, string> = {
  ...
  "/projects/rabita-ai": "Rabta AI. A production-grade, dual-agent WhatsApp commerce engine built for retail merchants. Powered by Python 3.14, FastAPI, LangGraph, and native Google Gemini 3.5 Flash Lite, Rabta AI couples a warm Roman Urdu sales closer with an owner co-pilot node, integrates multimodal intelligence—auditing studio catalog photos via Gemini Vision rollmark detection and processing bilingual voice notes through Deepgram Nova-3—and enforces strict Human-in-the-Loop guardrails for absolute zero-hallucination catalog accuracy.",
